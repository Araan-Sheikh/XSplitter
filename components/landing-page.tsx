...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="px-4 md:px-8 flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] py-16">
      ...
      <section className="bg-muted/50 px-4 md:px-8 py-16 md:py-24">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
          How It Works
        </h2>
      ...
      <footer className="border-t bg-background">
        <div className="px-4 md:px-8 h-16 flex flex-col sm:flex-row items-center justify-between">
